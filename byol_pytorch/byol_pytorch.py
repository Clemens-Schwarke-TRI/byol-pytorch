...
class BYOL(nn.Module):
    ...
    def forward(self, image_a, image_b, return_embedding=False, return_projection=True):
        assert not (
        ...
        with torch.no_grad():
            ...
            target_proj_a, target_proj_b = target_projections.chunk(2, dim=0)

        loss_a = loss_fn(online_pred_a, target_proj_b.detach())
        loss_b = loss_fn(online_pred_b, target_proj_a.detach())
